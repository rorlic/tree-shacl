...
rm -rf ./temp/*
cd ./src
riot --quiet --formatted turtle $(tr '\n' ' ' < ../build/shapes-common.txt) > ../temp/tree-collection-node-shapes.ttl
riot --quiet --formatted turtle $(tr '\n' ' ' < ../build/shapes-common.txt) > ../temp/tree-root-node-shapes.ttl
riot --quiet --formatted turtle $(tr '\n' ' ' < ../build/shapes-common.txt) > ../temp/tree-subsequent-node-shapes.ttl
